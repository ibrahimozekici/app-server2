...
API_VERSION := $(shell go list -m -f '{{ .Version }}' github.com/ibrahimozekici/lora-api/go/v3 | awk '{n=split($$0, a, "-"); print a[n]}')
...
proto:
	...
	@git clone https://github.com/ibrahimozekici/lora-api.git /tmp/chirpstack-api
